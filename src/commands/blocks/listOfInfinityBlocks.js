...
const { fetchNameOfAllBlocksAsArray } = require("../../utils/jsonLookup/fetchByBlocks.js").InfBlocks;
...
module.exports = {
	...
	aliases: [],
	category: "blocks",
	utilisation: "all-inf-blocks",
	description: "Returns a list of all inf blocks.",
		...
		try {
			...
			for (let i = 0; i < NumberOfPages; ++i) {
				...
				const newEmbed = new EmbedBuilder()
					.setTitle(`List of all inf blocks`)
			...
			logError("error in listofall inf blocks", error);
